...
function ServiceCard({ service }) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`absolute shadow-lg md:p-5 lg:min-h-[145px] flex flex-col gap-2 items-center lg:top-50 top-35 lg:left-10 lg:right-10 left-5 right-5 bg-white transition-all duration-300 p-3 border-b-black rounded-lg ${
          isActive
