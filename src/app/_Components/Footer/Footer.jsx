          ...
          <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-600 hover:text-gray-800 active:text-gray-800 cursor-pointer">First Link</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800 active:text-gray-800 cursor-pointer">Second Link</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800 active:text-gray-800 cursor-pointer">Third Link</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800 active:text-gray-800 cursor-pointer">Fourth Link</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            ...
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a className="text-gray-500 hover:text-gray-700 active:text-gray-700 transition-colors cursor-pointer">
                <svg fill="currentColor"  strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                </svg>
              </a>
              <a className="ml-3 text-gray-500 hover:text-gray-700 active:text-gray-700 transition-colors cursor-pointer">
                <svg fill="currentColor"  strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
